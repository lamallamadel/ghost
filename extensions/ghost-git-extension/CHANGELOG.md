...
### Added
- **ghost add command**: New command for staging files with proactive security scanning.
- **Proactive Secret Scanning**: Automatically scans files for secrets *before* staging them, with a block and --force override.

### Changed
- Improved `test.js` to support mocking of core-level intents.
- Refactored `extension.js` to allow better testability of SDK-based intents.
